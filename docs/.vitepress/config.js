...
export default defineConfig({
  ...
  base: process.env.NODE_ENV === 'production' ? '/sophigo/docs/' : '/docs/', // namespace prefix for assets and pages
  
  themeConfig: {
    logo: '/logo.svg',
    nav: [
      { text: '返回主站', link: process.env.NODE_ENV === 'production' ? '/sophigo/' : 'http://localhost:5173' },
      { text: '开发文档主页', link: '/' },
      { 
        text: '课程目录', 
        items: [
