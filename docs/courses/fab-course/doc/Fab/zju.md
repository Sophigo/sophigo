...
|3D printing|增加软件端参数设置，设备启动方式，翘边问题展示和解决方式|20201217|wait |
|CNC machine |等待更新|20201217| wait|
|Mid presentation |细化形态，解决的问题，效果，期间可能会遇到的问题|20201217|wait |
...
|3D printing|待更新|20121217|wait |
|CNC machine |待更新|20121217|wait |
...
|Topic|    Question        | time           | Condation  |	
| ------------- | ------------- |:-------------:| -----:|
| Project management  |    在课程日志中增加网站搭建方式（图文），使用工具，参考资料；团队成员介绍检查|20201101| Wait |
